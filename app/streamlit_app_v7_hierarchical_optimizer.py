...
with st.sidebar:
    ...
    # st.markdown("---")
    # st.write("DEBUG", {
    #     "bvol_city": bvol_city, "bldh_city": bldh_city, "pop_city": pop_city,
    #     "dT2_city": dT2_city, "dRH_city": dRH_city, "infilling_city": infilling_city, "ahem_city": ahem_city,
    #     "enable_local": enable_local, "selected_pixels": len(st.session_state.selected_pixels),
    # })
