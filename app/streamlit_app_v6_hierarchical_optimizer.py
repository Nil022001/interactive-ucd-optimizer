...
# =========================================================
# LEFT POP-UP (Slider panel lives in sidebar; hidden by default)
# =========================================================
# Streamlit only supports a built-in left "sidebar" (collapsible).
# This puts ALL sliders there (not at the top of the main page).
# Tip: in the app UI, click the small ">" arrow to open/close the left panel.

with st.sidebar:
    st.markdown("<h3 style='color:#7a0019;'>City-level scenario</h3>", unsafe_allow_html=True)
    ...
    st.markdown("---")
    st.markdown("<h4 style='color:#7a0019;'>Local project overrides (multi-pixel)</h4>", unsafe_allow_html=True)
    st.caption("Applies ONLY to the selected pixels (on top of city-level scenario).")
