...
# Use baseline dT_cool (stored in parquet) and baseline RH_base etc.
feature_map_base = {
    "dT_cool": "dT_cool",
    "RH": "RH_base",
    "bvol": "bvol",
...
# Setpoint (scenario only) => compute dT_cool_city
...
if enable_local and len(selected) > 0:
    ...
    # recompute setpoint for final (same setpoint settings, but keep per-pixel stable)
    # (Tset_final already defined; keep it)
